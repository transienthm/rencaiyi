...
public class FinalSeg {
    ...
    private static final String PROB_EMIT = "/segment/prob_emit.txt";
    ...
    private void loadModel() {
        ...
        try {
            ...
            this.logger.error(String.format(Locale.getDefault(), "%s: load model failure!", PROB_EMIT));
        }
        finally {
            try {
                if (null != is)
                ...
                this.logger.error(String.format(Locale.getDefault(), "%s: close failure!", PROB_EMIT));
            }
        }
        this.logger.info(String.format(Locale.getDefault(), "model load finished, time elapsed %d ms.",
