...
@Data
@NoArgsConstructor
public class ReviewTemplateContainRevieweeProfilesVO {
  ...
  List<CoreUserProfileVO> revieweeProfileList;
  ...
  public void setInvitedTeamVOs(List<TeamVO> invitedTeamVOs) {
    this.invitedTeamVOs = invitedTeamVOs;
  }
}
