 ...
 * @Created: 2016-06-29
 */
@Component("onboardingMetaPermissionChecker")
public class OnboardingMetaPermissionChecker {

  private static final Logger LOGGER = LoggerFactory.getLogger(OnboardingMetaPermissionChecker.class);
  ...
  public boolean canCreate(long orgId, long actorUserId) {
    return permissionUtil.getPermissionForSingleObj(
        orgId, actorUserId, 0L, orgId, ResourceCode.ONBOARDING_META.getResourceCode(),
