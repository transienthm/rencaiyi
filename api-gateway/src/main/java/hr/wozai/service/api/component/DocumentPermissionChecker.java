 ...
 * @Created: 2016-06-29
 */
@Component("documentMetaPermissionChecker")
public class DocumentPermissionChecker {

  private static final Logger LOGGER = LoggerFactory.getLogger(DocumentPermissionChecker.class);
  ...
  public boolean canCreate(long orgId, long actorUserId) {
    return permissionUtil.getPermissionForSingleObj(
        orgId, actorUserId, 0L, orgId, ResourceCode.DOCUMENT.getResourceCode(),
